...
def main():
    ...
    if data_file_1 is not None:
        ...
        if graph_type == 'Barras':
            ...
            bank_raw_target_perc.plot(kind='pie', autopct='%.2f%%', y='percentage', ax=ax[0], legend=False)
            ax[0].set_title('Dados brutos', fontweight="bold")

            bank_target_perc.plot(kind='pie', autopct='%.2f%%', y='percentage', ax=ax[1], legend=False)
            ax[1].set_title('Dados filtrados', fontweight="bold")
